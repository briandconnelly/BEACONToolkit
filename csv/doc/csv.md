...
First, we should tell R which directory we'll be working in so it knows where
to load files from. We can do that with the `setwd` function:
...
dataframe. In this case, it looks something like this:
    ...
    1     0 00:00:00    3611.0103
    2     1 00:00:00  431926.7093
    3     2 00:00:00  447315.1140
    4     3 00:00:00  481894.3989
...
will look like this:
	    ...
	    Row     Time Luminescence.mean Luminescence.sd
	1     0 00:00:00         3611.0103       1600.1309
	2     1 00:00:00       431926.7093     748578.7586
	3     2 00:00:00       447315.1140     743559.0518
	4     3 00:00:00       481894.3989     756660.9707
...
to a csv file we can send to colleagues or save for future analysis. 
	...
	# save the new data
	write.csv(new_data, 'luminescence_row_means_and_sd.csv')
